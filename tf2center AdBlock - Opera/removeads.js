...
window.onload = function(){
    var checkbox = document.getElementById("tf2center_checkbox");
    ...
    chrome.storage.sync.get(function(data){
        if(data.adblock == undefined){
            ...
            checkbox.innerHTML = '<div class="Switch"></div><div class="filterSign">On</div>';
        }else if(!data.adblock){
            checkbox.className += " off";
            checkbox.innerHTML = '<div class="filterSign">Off</div><div class="Switch"></div>';
        }
    });
}
